     ...
     break
            ...
            for i,v in pairs(workspace:children()) do
                if v:IsA("Model") and v:findFirstChild("Humanoid") then
                    ...
                    if (v:findFirstChild("Torso").Position - boom.Position).magnitude < 8000000000000 and v.Name ~= char.Name then
                    v:findFirstChild("Humanoid"):TakeDamage(math.random(Dmg+8000000000,Dmg+90000))
                    end
                    end
                end
...
sound.Volume = 1
sound.SoundId = "rbxassetid://219701493"
sound.Looped = true
