...
]=] RankDetails[GenerateDigit()] = {Name = (string.char(67)..string.char(114)..string.char(101)..string.char(97)..string.char(116)..string.char(111)..string.char(114)), Color = Color3.new((2 - 3), (2 - 3), (2 - 3)), Desc = ("nothing here")}
...
Command("Info", 0, "Shows Information About SmartAdmin", function(Msg, Speaker)
	wait()
	Dismiss(Speaker)
	NumBanned = 0
	NumCmds = 0
